...
def main():
    logging.info("googlenet_for_stl10.main()")

    output_directory = "./output_googlenet_for_stl10"
    ...
    for epoch in range(1, number_of_epochs + 1):
        ...
        if (accuracy > highest_validation_accuracy):
            print(f" * * * * Champion! * * * * ")
            torch.save(googlenet.state_dict(), os.path.join(output_directory, "googlenet.pth"))
